...
function modifier_shadow_ambush_buff:OnCreated()
	...
	if caster.shadow_ambush_bonus then
		...
		self.attack_bonus = caster.shadow_ambush_bonus * caster:GetAverageTrueAttackDamage(caster) / 10.0
		self.particle = ParticleManager:CreateParticle("", PATTACH_ABSORIGIN, caster)
