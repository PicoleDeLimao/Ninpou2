...
function Equip(event)
	...
	if caster.numYangOrbs == 1 then 
		local particle = ParticleManager:CreateParticle("particles/econ/courier/courier_axolotl_ambient/courier_axolotl_ambient_lvl4_magic.vpcf", PATTACH_ABSORIGIN_FOLLOW, caster)
